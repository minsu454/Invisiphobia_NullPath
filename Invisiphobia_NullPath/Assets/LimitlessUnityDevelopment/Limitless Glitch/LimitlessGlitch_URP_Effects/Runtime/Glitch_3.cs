...
public class Glitch_3 : ScriptableRendererFeature
{
    ...
    public class Glitch3Pass : ScriptableRenderPass
    {
        ...
        {
            renderPassEvent = evt;
            var shader = Shader.Find("LimitlessGlitch/Glitch_3");
            if (shader == null)
            {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            Glitch3 = stack.GetComponent<Limitless_Glitch3>();
