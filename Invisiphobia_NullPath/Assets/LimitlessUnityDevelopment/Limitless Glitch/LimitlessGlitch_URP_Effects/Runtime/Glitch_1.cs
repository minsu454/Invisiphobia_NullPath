...
public class Glitch_1 : ScriptableRendererFeature
{
    ...
    public class Glitch1Pass : ScriptableRenderPass
    {
        ...
        {
            renderPassEvent = evt;
            var shader = Shader.Find("LimitlessGlitch/Glitch_1");
            if (shader == null)
            {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            glitch1 = stack.GetComponent<Limitless_Glitch1>();
