...
namespace Michsky.UI.Dark
{
    ...
    public class ButtonManager : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler
    {
        ...
        void Start()
        {
            ...
            if (enableButtonSounds && useClickSound) { buttonVar.onClick.AddListener(delegate { Managers.Sound.SFX2DPlay(clickSound); }); }
	   ...
	   if (useCustomContent)
        ...
        {
            yield return YieldCache.WaitForSecondsRealtime(cachedStateLength);
